...
| 其他负债 / 担保 | ❓ | | |
| 社保医保 | ❓ | | |
| 商保概况 | 已有商业保单（客户 R3 提供保单照片；具体险种与保额待核对） | R3 | 这是保单照片，你先看一下。 |
| 团险 / 福利 | ❓ | | |
...
| H5 收入 | 未满足 | 已收集 |
| H6 支出 | 未满足 | 已收集 |
| 是否可进入 Needs Analysis | 否 | 仍有 6 项 Hard Required 未满足 |
...
```
由 apply-execution.ps1 依据 evals/executions/CASE_007-A.json 渲染
```
