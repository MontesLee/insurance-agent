...
| H5 收入 | 已满足 | 已收集 |
| H6 支出 | 未满足 | 已收集 |
| 是否可进入 Needs Analysis | 否 | 仍有 5 项 Hard Required 未满足 |
...
```
由 apply-execution.ps1 依据 evals/executions/CASE_006.json 渲染
```
