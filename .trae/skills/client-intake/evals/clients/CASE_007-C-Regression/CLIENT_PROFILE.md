...
| P0 | 商保概况（3 次提醒未果，已 expired） | Hard Required 未满足 |
...
| H5 收入 | 未满足 | 已收集 |
| H6 支出 | 未满足 | 已收集 |
| 是否可进入 Needs Analysis | 否 | 仍有 7 项 Hard Required 未满足 |
...
```
由 apply-execution.ps1 依据 evals/executions/CASE_007-C.json 渲染
```
