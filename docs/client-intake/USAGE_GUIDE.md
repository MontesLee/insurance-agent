...
| 状态持久化 | 多轮状态靠 JSON 传，冲突就打架 | [CLIENT_PROFILE.md](file:///D:/Workspace/insurance-agent/.trae/skills/client-intake/resources/templates/CLIENT_PROFILE.md) **唯一长期状态源**，三份状态文件分离职责，SOP §2.2 明确定义优先级：Profile > Pending > Log > JSON |
...
#### 3.4.1 [CLIENT_PROFILE.md](file:///D:/Workspace/insurance-agent/.trae/skills/client-intake/resources/templates/CLIENT_PROFILE.md) — 唯一长期事实源（后续 Skill 只读这份！）
...
#### 3.4.2 [CONVERSATION_LOG.md](file:///D:/Workspace/insurance-agent/.trae/skills/client-intake/resources/templates/CONVERSATION_LOG.md) — 历史+QID 注册表（不作为长期事实源，I6 历史留痕专用）
...
#### 3.4.3 [PENDING.md](file:///D:/Workspace/insurance-agent/.trae/skills/client-intake/resources/templates/PENDING.md) — 答应补的资料+提醒节奏（与 QID 强同步 SOP §六 34-39 行同步规则）
