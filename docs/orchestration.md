...
> 前置：Phase 0 审计 `docs/architecture-v2-audit.md`（只读基线，未修改）· Phase 1 契约层 `docs/contract-layer.md`。
...
## 3. Workflow（`workflow/insurance-analysis.yaml`）
