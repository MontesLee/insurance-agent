...
Phase 1 只读审计见 **`docs/dev-notes/step4-audit.md`**（10 问逐一回答 + 文件:行 证据）。核心发现：
...
完整图 + 执行方式标记（Deterministic/LLM/RAG/External）见 **`docs/architecture/architecture.md`**。
...
eval_status / duration_ms / timestamp`。详见 `docs/architecture/execution-trace.md`。
...
## 6. Failure Taxonomy（`docs/architecture/failure-taxonomy.md`）
...
| **`docs/architecture/architecture.md`**（新建） | 架构总图 + 执行方式标记（Deterministic / LLM / RAG / External Data） |
...
| `docs/dev-notes/step4-audit.md` | Phase 1 只读审计（10 问 + 证据） |
| `docs/architecture/execution-trace.md` | Execution Trace 事件枚举与字段 |
| `docs/architecture/failure-taxonomy.md` | F1–F12 + Failure Matrix |
| `docs/architecture/orchestration.md` / `docs/architecture/contract-layer.md` / `docs/architecture/architecture-v2.md` / `docs/architecture/evidence-provider.md` / `docs/architecture/product-recommendation-v2.md` / `docs/architecture/report-generation-v2.md` / `docs/dev-notes/step2-evidence-recommendation.md` / `docs/dev-notes/step3-assembly.md` | Step 1–3 既有技术文档 |
...
| Phase | 内容 | 状态 |
|---|---|---|
| P1 | 架构审计 | ✅ `docs/dev-notes/step4-audit.md` |
...
| P6 | Failure Taxonomy F1–F12 | ✅ `docs/architecture/failure-taxonomy.md` |
...
| P12 | Documentation + ADR | ✅ `README.md` / `docs/architecture/architecture.md` / `docs/adr/*` |
