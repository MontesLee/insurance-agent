...
|------|-------------|------|--------------|-------------------|----------|------------|----------------|------|
| P001 | Q004 | 现有商保保单具体明细 | 保险保单我晚点找一下发给你 | R2 | pending | 0 | R4（R2+2） | Intake 已完成，在 Needs Analysis 阶段按节奏温和提醒即可 |
...
- 第 1 次提醒：进入 Pending 后第 2 个后续 Round → P001 下次提醒：R4
- 第 2 次提醒：进入 Pending 后第 4 个后续 Round → P001 第 2 次提醒：R6
- 第 3 次提醒：进入 Pending 后第 6 个后续 Round → P001 第 3 次提醒：R8
- 提醒话术尽量温和，不每轮追问；鉴于 Intake 已完成，提醒可在 Needs Analysis 场景下顺带提及
